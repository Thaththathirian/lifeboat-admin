...
const initialMessages = [
  { id: 1, subject: "Update Required", body: "Please update your annual profile to continue receiving notifications and manage students.", date: "2024-01-16", read: false },
  { id: 2, subject: "Receipt Pending", body: "Upload the pending student fee receipts for the current semester.", date: "2024-01-10", read: false },
  { id: 3, subject: "Welcome", body: "Welcome to the LBF College Portal! Here you can manage students, verify payments, and download reports.", date: "2023-12-25", read: true }
];
      ...
      <Card className="shadow-soft">
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>Inbox for admin/college communication</CardDescription>
          </div>

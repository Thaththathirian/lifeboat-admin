...
const initialNotifications = [
  { id: 1, title: "Profile Update Required", body: "Please update your annual profile to continue using the portal.", date: "2024-01-15", read: false },
  { id: 2, title: "Receipt Pending", body: "Upload the pending student fee receipts for the current semester.", date: "2024-01-10", read: false },
  { id: 3, title: "Welcome", body: "Welcome to the LBF College Portal! Here you can manage students, verify payments, and download reports.", date: "2023-12-25", read: true }
];
